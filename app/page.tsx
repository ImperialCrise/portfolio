...
const translations = {
  en: {
    ...
    aiBackendIntern: "AI Back-end Engineer Intern",
    historyRefactor: "Refactored the History project using Serverless framework for AWS, modernizing API deployment",
    makefileCreation: "Created comprehensive pipeline for project compilation, deployment, and local testing",
    asyncSystem: "Developed asynchronous system improvements for batch processing and background task execution",
    streamPublishing: "Optimized stream publishing process, reducing deployment time and improving reliability",
  ...
  fr: {
    ...
    aiBackendIntern: "Stagiaire Ingénieur IA Back-end",
    historyRefactor: "Refonte du projet History en utilisant le framework Serverless pour AWS, modernisant le déploiement de l'API",
    makefileCreation: "Création d'une pipeline complet pour la compilation, le déploiement et les tests locaux du projet",
    asyncSystem: "Développement d'améliorations du système asynchrone pour le traitement par lots et l'exécution de tâches en arrière-plan",
    streamPublishing: "Optimisation du processus de publication en stream, réduisant le temps de déploiement et améliorant la fiabilité",
